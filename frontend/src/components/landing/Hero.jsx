                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        >
                            <Link
                                to="/register"
                                className="btn-primary px-8 py-4 rounded-full text-lg font-semibold shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all"
                            >
                                Get Started Free
                            </Link>
                            <button
                                onClick={() => scrollToSection('pricing')}
                                className="btn-outline px-8 py-4 rounded-full text-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all bg-white"
                            >
                                View Pricing
                            </button>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="flex flex-wrap gap-8 justify-center lg:justify-start text-sm text-gray-600"
                        >
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-medium">24-48hr Delivery</span>
                            </div>
                        </motion.div>
                    </motion.div>
                    ...
                    >
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="font-semibold text-gray-800">Unlimited Revisions</p>
