...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            <div className={`fixed left-0 top-0 h-screen w-64 ${sidebarTheme === 'dark' ? 'bg-[#0A0E1A] border-r border-[#1E2638]' : 'bg-white border-r border-gray-100 shadow-[4px_0_24px_rgba(0,0,0,0.02)]'} flex flex-col z-50 transition-all duration-300 transform ${isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
                {/* Logo */}
                <div className={`p-8 ${sidebarTheme === 'dark' ? 'border-b border-[#1E2638]' : 'border-b border-gray-50'} flex justify-between items-center`}>
