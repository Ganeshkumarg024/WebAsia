                    ...
                    <div className="flex items-center justify-between px-4 lg:px-8 py-4 gap-4">
                        ...
                        <div className="flex-1 max-w-md hidden md:block">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2 rounded-lg border bg-gray-50 border-gray-100 text-gray-900 placeholder-gray-500 focus:outline-none focus:border-blue-500 transition-all"
                                />
                            </div>
                        </div>
                            ...
                            <div className="hidden md:flex items-center gap-2 text-sm">
                                {breadcrumbs.map((crumb, index) => (
                                    <div key={index} className="flex items-center gap-2">
                                        ...
                                        <span className={index === breadcrumbs.length - 1 ? 'text-gray-900' : 'text-gray-400'}>
                                            {crumb}
                                        </span>
                                    </div>
                                ))}
                        ...
                        <div className="flex items-center gap-2 lg:gap-4 relative ml-auto">
                            ...
                            <button
                                ...
                                className="relative p-2 rounded-lg transition-colors text-gray-400 hover:text-gray-900 hover:bg-gray-50"
                                aria-label="Notifications"
                            >
                                <BellIcon className="w-6 h-6" />
                                {unreadCount > 0 && (
                                    <div className="absolute top-1.5 right-1.5 w-4 h-4 bg-red-600 rounded-full flex items-center justify-center text-[10px] font-black text-white ring-2 ring-white">
                            ...
                            {showNotifications && (
                                <div className="absolute right-0 top-12 w-80 max-h-[480px] overflow-hidden rounded-2xl border shadow-2xl z-50 animate-in fade-in zoom-in-95 duration-200 bg-white border-gray-100 shadow-gray-200/50">
                                    <div className="p-4 border-b flex items-center justify-between border-gray-50">
                                        <h3 className="text-xs font-black uppercase tracking-widest text-gray-900">Signals</h3>
